...
class posts_UC_estudantes extends \core_external\external_api {
    ...
    public static function execute($ano_lectivo) {
        ...
        $query = "SELECT /*+ MAX_EXECUTION_TIME(0) */
                  ...
                  FROM mdl_forum_posts forPst
                      ...
                      INNER JOIN mdl_user std ON (std.id = rl.userid AND std.id = forPst.userid)
                  ...
                  GROUP BY std.username, LEFT(crs.idnumber, 5)
                  ORDER BY std.username ASC, crs.idnumber ASC;";
    ...
    public static function execute_returns() {
        return new external_multiple_structure(
            new external_single_structure([
                ...
                'tpost' => new external_value(PARAM_INT, 'total de posts'),
            ])
        );
    }
}
